...
public class DoctorWorkAreaJPanel extends javax.swing.JPanel {
     ...
     */
    public DoctorWorkAreaJPanel(JPanel userProcessContainer, UserAccount account, DoctorOrganization organization, Enterprise enterprise, EcoSystem system, Network sourceNetwork) {
        initComponents();
    ...
    private void initComponents() {
        ...
        add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(24, 123, 450, 100));
        ...
        add(requestTestJButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(205, 263, -1, -1));
        ...
        add(refreshTestJButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(730, 38, -1, -1));

        enterpriseLabel.setFont(new java.awt.Font("Times New Roman", 1, 18)); // NOI18N
        enterpriseLabel.setText("EnterPrise :");
        add(enterpriseLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(46, 26, 127, 30));

        valueLabel.setText("<value>");
        add(valueLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(203, 26, 158, 26));
        ...
        add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(536, 123, 390, 100));
        ...
        add(requestTestJButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(531, 478, 395, -1));
        ...
        add(jScrollPane3, new org.netbeans.lib.awtextra.AbsoluteConstraints(531, 342, 395, 97));
        ...
        add(requestTestJButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(573, 263, -1, -1));
        ...
        add(jScrollPane4, new org.netbeans.lib.awtextra.AbsoluteConstraints(21, 342, 467, 102));
        ...
        add(requestTestJButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(21, 478, -1, -1));
        ...
        add(networkComboBox, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 601, -1, -1));

        jLabel1.setFont(new java.awt.Font("Times New Roman", 1, 24)); // NOI18N
        jLabel1.setText("Select network");
        add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(229, 604, -1, -1));

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Image/Image11.jpg"))); // NOI18N
        add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1970, 1170));
    ...
    private void requestTestJButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_requestTestJButton1ActionPerformed
        ...
        CardLayout layout = (CardLayout) userProcessContainer.getLayout();
        userProcessContainer.add("RequestLabTestJPanel", new RequestDoctorToPharmacyAgentJPanel(userProcessContainer, userAccount, enterprise, system, sourceNetwork, (Network)networkComboBox.getSelectedItem()));
        layout.next(userProcessContainer);
    ...
    private void requestTestJButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_requestTestJButton2ActionPerformed
        // TODO add your handling code here:
        CardLayout layout = (CardLayout) userProcessContainer.getLayout();
        userProcessContainer.add("RequestLabTestJPanel", new RequestDoctorToYogaTrainerJPanel(userProcessContainer, userAccount, enterprise, system, sourceNetwork, (Network)networkComboBox.getSelectedItem()));
        layout.next(userProcessContainer);
    ...
    private void requestTestJButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_requestTestJButton3ActionPerformed
            // TODO add your handling code here:
        CardLayout layout = (CardLayout) userProcessContainer.getLayout();
        userProcessContainer.add("RequestLabTestJPanel", new RequestDoctorToHealthcareInsuranceAgentJPanel(userProcessContainer, userAccount, enterprise, system, sourceNetwork, (Network)networkComboBox.getSelectedItem()));
        layout.next(userProcessContainer);
