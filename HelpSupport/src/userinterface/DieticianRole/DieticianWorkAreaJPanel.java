...
public class DieticianWorkAreaJPanel extends javax.swing.JPanel {
     ...
     */
    public DieticianWorkAreaJPanel(JPanel userProcessContainer, UserAccount account, DieticianOrganization organization, Enterprise enterprise, EcoSystem system, Network sourceNetwork) {
        initComponents();
        ...
        populateDieticianToNurseRequestTable();
        populateDieticianToHealthInsuranceAgentRequestTable();
        populateDieticianToPharmacyAgentRequestTable();
    }
    ...
    public void populateDieticianToNurseRequestTable() {
    ...
    public void populateDieticianToHealthInsuranceAgentRequestTable() {
    ...
    public void populateDieticianToPharmacyAgentRequestTable() {
    ...
    private void initComponents() {
        ...
        add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 149, 409, 101));

        requestTestJButton.setFont(new java.awt.Font("Times New Roman", 1, 24)); // NOI18N
        requestTestJButton.setText("Request Task To Yoga Trainer");
        requestTestJButton.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                requestTestJButtonActionPerformed(evt);
            }
        });
        add(requestTestJButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(142, 282, -1, -1));
        ...
        add(refreshTestJButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(533, 61, -1, -1));

        enterpriseLabel.setFont(new java.awt.Font("Times New Roman", 1, 18)); // NOI18N
        enterpriseLabel.setText("EnterPrise :");
        add(enterpriseLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(82, 61, 127, 30));

        valueLabel.setText("<value>");
        add(valueLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(227, 68, 158, 26));
        ...
        add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(625, 153, 312, 97));
        ...
        add(requestTestJButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(556, 518, -1, -1));
        ...
        add(jScrollPane3, new org.netbeans.lib.awtextra.AbsoluteConstraints(556, 362, 381, 100));
        ...
        add(requestTestJButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(651, 282, 286, -1));
        ...
        add(jScrollPane4, new org.netbeans.lib.awtextra.AbsoluteConstraints(37, 362, -1, 122));

        requestTestJButton3.setFont(new java.awt.Font("Times New Roman", 1, 24)); // NOI18N
        requestTestJButton3.setText("Request Task To Health Insurance Agent");
        requestTestJButton3.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                requestTestJButton3ActionPerformed(evt);
            }
        });
        add(requestTestJButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(36, 518, -1, -1));
        ...
        add(networkComboBox, new org.netbeans.lib.awtextra.AbsoluteConstraints(473, 641, -1, -1));

        jLabel1.setFont(new java.awt.Font("Times New Roman", 1, 24)); // NOI18N
        jLabel1.setText("Select network");
        add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(252, 644, -1, -1));

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Image/Image11.jpg"))); // NOI18N
        add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1970, 1020));
    ...
    private void requestTestJButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_requestTestJButton1ActionPerformed
        ...
        CardLayout layout = (CardLayout) userProcessContainer.getLayout();
        userProcessContainer.add("RequestLabTestJPanel", new RequestDieticianToPharmacyAgentJPanel(userProcessContainer, userAccount, enterprise, system, sourceNetwork, (Network)networkComboBox.getSelectedItem()));
        layout.next(userProcessContainer);
    ...
    private void requestTestJButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_requestTestJButton2ActionPerformed
        // TODO add your handling code here:
        CardLayout layout = (CardLayout) userProcessContainer.getLayout();
        userProcessContainer.add("RequestLabTestJPanel", new RequestDieticianToNurseJPanel(userProcessContainer, userAccount, enterprise, system, sourceNetwork, (Network)networkComboBox.getSelectedItem()));
        layout.next(userProcessContainer);
    ...
    private void requestTestJButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_requestTestJButton3ActionPerformed
        // TODO add your handling code here:
        CardLayout layout = (CardLayout) userProcessContainer.getLayout();
        userProcessContainer.add("RequestLabTestJPanel", new RequestDieticianToHealthcareInsuranceAgentJPanel(userProcessContainer, userAccount, enterprise, system, sourceNetwork, (Network)networkComboBox.getSelectedItem()));
        layout.next(userProcessContainer);
