 ...
 * @author raunak
 */
public class RequestPharmacistToYogaTrainerJPanel extends javax.swing.JPanel {
     ...
     */
    public RequestPharmacistToYogaTrainerJPanel(JPanel userProcessContainer, UserAccount account, Enterprise enterprise, EcoSystem system, Network sourceNetwork, Network targetNetwork) {
        initComponents();
    ...
    private void initComponents() {
        ...
        requestTestJButton.setBounds(450, 270, 169, 37);

        jLabel1.setFont(new java.awt.Font("Times New Roman", 1, 18)); // NOI18N
        jLabel1.setText("Message");
        add(jLabel1);
        jLabel1.setBounds(340, 200, 65, 22);
        add(messageJTextField);
        messageJTextField.setBounds(450, 200, 170, 20);
    ...
    private void backJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_backJButtonActionPerformed
        ...
        dwjp.populatePharmacistToYogaTrainerRequestTable();
