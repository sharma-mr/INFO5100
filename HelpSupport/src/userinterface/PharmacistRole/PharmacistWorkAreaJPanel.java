...
public class PharmacistWorkAreaJPanel extends javax.swing.JPanel {
     ...
     */
    public PharmacistWorkAreaJPanel(JPanel userProcessContainer, UserAccount account, PharmacistOrganization organization, Enterprise enterprise, EcoSystem system, Network sourceNetwork) {
        initComponents();
        ...
        populatePharmacistToNurseRequestTable();
        populatePharmacistToHealthcareInsuranceAgentRequestTable();
        populatePharmacistToYogaTrainerRequestTable();
    }
    ...
    public void populatePharmacistToNurseRequestTable(){
    ...
    public void populatePharmacistToYogaTrainerRequestTable(){
    ...
    public void populatePharmacistToHealthcareInsuranceAgentRequestTable(){
    ...
    private void initComponents() {
        ...
        add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(72, 115, 381, 97));

        requestTestJButton.setFont(new java.awt.Font("Times New Roman", 1, 24)); // NOI18N
        requestTestJButton.setText("Request Task To Pharmacy Agent");
        requestTestJButton.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                requestTestJButtonActionPerformed(evt);
            }
        });
        add(requestTestJButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(72, 246, -1, -1));
        ...
        add(refreshTestJButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(502, 28, -1, -1));

        enterpriseLabel.setFont(new java.awt.Font("Times New Roman", 1, 18)); // NOI18N
        enterpriseLabel.setText("EnterPrise :");
        add(enterpriseLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(72, 47, 127, 30));

        valueLabel.setText("<value>");
        add(valueLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(208, 49, 158, 26));
        ...
        add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(607, 331, -1, 100));

        requestTestJButton1.setFont(new java.awt.Font("Times New Roman", 1, 24)); // NOI18N
        requestTestJButton1.setText("Request Task To Health Insurance Agent");
        requestTestJButton1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                requestTestJButton1ActionPerformed(evt);
            }
        });
        add(requestTestJButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(607, 477, -1, -1));
        ...
        add(jScrollPane3, new org.netbeans.lib.awtextra.AbsoluteConstraints(669, 116, 390, 96));

        requestTestJButton2.setFont(new java.awt.Font("Times New Roman", 1, 24)); // NOI18N
        requestTestJButton2.setText("Request Task To Nurse");
        requestTestJButton2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                requestTestJButton2ActionPerformed(evt);
            }
        });
        add(requestTestJButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(774, 246, 286, -1));
        ...
        add(jScrollPane4, new org.netbeans.lib.awtextra.AbsoluteConstraints(72, 331, 381, 100));

        requestTestJButton3.setFont(new java.awt.Font("Times New Roman", 1, 24)); // NOI18N
        requestTestJButton3.setText("Request Task To Yoga Trainer");
        requestTestJButton3.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                requestTestJButton3ActionPerformed(evt);
            }
        });
        add(requestTestJButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(98, 477, 355, -1));

        jLabel1.setFont(new java.awt.Font("Times New Roman", 1, 24)); // NOI18N
        jLabel1.setText("Select network");
        add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(223, 548, -1, -1));
        ...
        add(networkComboBox, new org.netbeans.lib.awtextra.AbsoluteConstraints(444, 545, -1, -1));

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Image/Image11.jpg"))); // NOI18N
        add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1960, 1100));
    ...
    private void requestTestJButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_requestTestJButton1ActionPerformed
        ...
        CardLayout layout = (CardLayout) userProcessContainer.getLayout();
        userProcessContainer.add("RequestLabTestJPanel", new RequestPharmacistToHealthcareInsuranceAgentJPanel(userProcessContainer, userAccount, enterprise, system, sourceNetwork, (Network)networkComboBox.getSelectedItem()));
        layout.next(userProcessContainer);
    ...
    private void requestTestJButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_requestTestJButton2ActionPerformed
        // TODO add your handling code here:
        CardLayout layout = (CardLayout) userProcessContainer.getLayout();
        userProcessContainer.add("RequestLabTestJPanel", new RequestPharmacistToNurseJPanel(userProcessContainer, userAccount, enterprise, system, sourceNetwork, (Network)networkComboBox.getSelectedItem()));
        layout.next(userProcessContainer);
    ...
    private void requestTestJButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_requestTestJButton3ActionPerformed
        // TODO add your handling code here:
        CardLayout layout = (CardLayout) userProcessContainer.getLayout();
        userProcessContainer.add("RequestLabTestJPanel", new RequestPharmacistToYogaTrainerJPanel(userProcessContainer, userAccount, enterprise, system, sourceNetwork, (Network)networkComboBox.getSelectedItem()));
        layout.next(userProcessContainer);
